    ...
    render () {
        return <div id="about">
            ...
            <Row className="table">
                ...
                <Col xs={12} sm={12} md={4} lg={4}>
                    <div id="about_row">
                        <img src="img/preferences-calendar-and-tasks_4520.png"/>
                ...
                <Col xs={12} sm={12} md={4} lg={4}>
                    <div id="about_row">
                        <img src="img/imgonline-com-ua-resize-DQ2B0NETs4.jpg"/>
            ...
            <Row className="table">
                <Col xs={12} sm={12} md={4} lg={4}>
                    <div id="about_row">
                        <img src="img/user_info_5274.png"/>
                ...
                <Col xs={12} sm={12} md={4} lg={4}>
                    <div id="about_row">
                        <img src="img/imgonline-com-ua-resize-FlGDhvYW6R.jpg"/>
                        <h2>Design</h2>
                        <br/>
